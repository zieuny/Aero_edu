  ...
  return (
    <div className="p-8 max-w-6xl mx-auto">
      <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
        <div>
          <h2 className="text-3xl font-bold text-slate-900 tracking-tight">Vibe Coding Prompts</h2>
          <p className="text-slate-500 mt-1">Specialized prompt library for autonomous software development.</p>
        </div>
        ...
        <div className="relative">
          ...
          <input
            ...
            className="pl-10 pr-4 py-2 bg-white border border-slate-200 rounded-xl w-full md:w-64 focus:ring-2 focus:ring-blue-500 outline-none transition-all"
          />
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 gap-4">
        {filteredPrompts.map((prompt) => (
          <motion.div
            ...
            className="bg-white border border-slate-200 rounded-2xl p-6 hover:border-blue-200 transition-colors group relative shadow-sm"
          >
            ...
            <div className="bg-slate-900 rounded-xl p-4 font-mono text-sm text-slate-300 relative group-hover:text-white transition-colors">
              <div className="absolute top-2 right-2 text-[10px] text-slate-600 font-bold uppercase tracking-tighter">Markdown</div>
              {prompt.content}
            </div>
          </motion.div>
        ))}
